...
assignment(top, child, x, self, gensymattrib). %a40
...
assignment(top, child, yr, self, gensymattrib). %a40
...
assignment(top, child, y, self, gensymattrib). %a40
assignment(top, child, xr, self, gensymattrib). %a40
...
assignment(hbox, self, mult, self, absdist). %a42
...
assignment(vbox, self, mult, self, absdist). %a42
...
assignment(leaf, self, h, self, gensymattrib). %a40
...
assignment(leaf, self, mult, self, absdist). %a42
assignment(leaf, self, w, self, gensymattrib). %a40
