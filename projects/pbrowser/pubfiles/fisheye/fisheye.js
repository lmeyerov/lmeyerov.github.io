...
function vbox_mult ( _ale_arg1,  _ale_arg0) { return _ale_arg0 > _ale_arg1 ? 1.0 : ((_ale_arg1 / 4) * ((_ale_arg1 - _ale_arg0 + _ale_arg1 / 3) / _ale_arg1)); }
...
function leaf_mult ( _ale_arg1,  _ale_arg0) { return _ale_arg0 > _ale_arg1 ? 1.0 : ((_ale_arg1 / 4) * ((_ale_arg1 - _ale_arg0 + _ale_arg1 / 3) / _ale_arg1)); }
...
function hbox_mult ( _ale_arg1,  _ale_arg0) { return _ale_arg0 > _ale_arg1 ? 1.0 : ((_ale_arg1 / 4) * ((_ale_arg1 - _ale_arg0 + _ale_arg1 / 3) / _ale_arg1)); }
...
function visit_hbox_2(node) {
  ...
  setAttribSafe(node, "mult", hbox_mult(getAttribSafe(node, "radius"), getAttribSafe(node, "absdist")));
  logger.log("    hbox_mult: " + getAttribSafe(node, "mult"));
  logger.log("        radius: " + getAttribSafe(node, "radius"));
  logger.log("        absDist: " + getAttribSafe(node, "absdist"));
...
function visit_vbox_2(node) {
  ...
  logger.log("        y: " + getAttribSafe(node, "y"));
  logger.log("        x: " + getAttribSafe(node, "x"));
  setAttribSafe(node, "mult", vbox_mult(getAttribSafe(node, "radius"), getAttribSafe(node, "absdist")));
...
function visit_leaf_2(node) {
  ...
  logger.log("        y: " + getAttribSafe(node, "y"));
  logger.log("        x: " + getAttribSafe(node, "x"));
  setAttribSafe(node, "mult", leaf_mult(getAttribSafe(node, "radius"), getAttribSafe(node, "absdist")));
