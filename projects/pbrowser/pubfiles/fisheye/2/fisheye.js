...
function vbox_mult ( _ale_arg3,  _ale_arg0,  _ale_arg2,  _ale_arg4,  _ale_arg1) { return (((_ale_arg0 < (_ale_arg1 + _ale_arg2)) && (_ale_arg0 > (_ale_arg1 - _ale_arg2)) && (_ale_arg3 < (_ale_arg4 + _ale_arg2)) && (_ale_arg3 > (_ale_arg4 - _ale_arg2)))) ? 10.0 : 1.0; }
...
function vbox_render ( _ale_arg3,  _ale_arg1,  _ale_arg0,  _ale_arg2) { return paintRect(_ale_arg0, _ale_arg1, _ale_arg2, _ale_arg3, "#CCC"); }
...
function vbox_absDist ( _ale_arg6,  _ale_arg1,  _ale_arg3,  _ale_arg2,  _ale_arg5,  _ale_arg4,  _ale_arg0) { return sqrt(((_ale_arg0 + _ale_arg1 / 2 + _ale_arg2 / 0.5) - _ale_arg3) * ((_ale_arg0 + _ale_arg1 / 2 + _ale_arg2 / 0.5) - _ale_arg3) + ((_ale_arg4 + _ale_arg5 / 2 + _ale_arg2 / 0.5) - _ale_arg6) * ((_ale_arg4 + _ale_arg5 / 2 + _ale_arg2 / 0.5) - _ale_arg6)); }
function vbox_childs_radius ( _ale_arg0) { return _ale_arg0; }
function hbox_childs_rby ( _ale_arg1,  _ale_arg0) { return _ale_arg0 + _ale_arg1; }
function hbox_childs_radius ( _ale_arg0) { return _ale_arg0; }
...
function hbox_mult ( _ale_arg3,  _ale_arg0,  _ale_arg2,  _ale_arg4,  _ale_arg1) { return (((_ale_arg0 < (_ale_arg1 + _ale_arg2)) && (_ale_arg0 > (_ale_arg1 - _ale_arg2)) && (_ale_arg3 < (_ale_arg4 + _ale_arg2)) && (_ale_arg3 > (_ale_arg4 - _ale_arg2)))) ? 10.0 : 1.0; }
function hbox_render ( _ale_arg3,  _ale_arg1,  _ale_arg0,  _ale_arg2) { return paintRect(_ale_arg0, _ale_arg1, _ale_arg2, _ale_arg3, "#CCC"); }
function hbox_absDist ( _ale_arg6,  _ale_arg1,  _ale_arg3,  _ale_arg2,  _ale_arg5,  _ale_arg4,  _ale_arg0) { return sqrt(((_ale_arg0 + _ale_arg1 / 2 + _ale_arg2 / 0.5) - _ale_arg3) * ((_ale_arg0 + _ale_arg1 / 2 + _ale_arg2 / 0.5) - _ale_arg3) + ((_ale_arg4 + _ale_arg5 / 2 + _ale_arg2 / 0.5) - _ale_arg6) * ((_ale_arg4 + _ale_arg5 / 2 + _ale_arg2 / 0.5) - _ale_arg6)); }
...
function top_h ( _ale_arg0,  _ale_arg1) { return _ale_arg0 + _ale_arg1 * 2; }
...
function top_child_radius ( _ale_arg0) { return _ale_arg0; }
...
function top_w ( _ale_arg0,  _ale_arg1) { return _ale_arg0 + _ale_arg1 * 2; }
...
function leaf_render ( _ale_arg6,  _ale_arg4,  _ale_arg5,  _ale_arg1,  _ale_arg2,  _ale_arg0,  _ale_arg3) { return _ale_arg0 + ((((_ale_arg1 > _ale_arg2) && (_ale_arg1 < (_ale_arg2 + _ale_arg3)) && (_ale_arg4 > _ale_arg5) && (_ale_arg4 < (_ale_arg5 + _ale_arg6)))) ? paintRect(_ale_arg2, _ale_arg5, _ale_arg3, _ale_arg6, "#F00") : paintRect(_ale_arg2, _ale_arg5, _ale_arg3, _ale_arg6, "#CCF")); }
function leaf_w ( _ale_arg0) { return _ale_arg0 * 2; }
function leaf_mult ( _ale_arg3,  _ale_arg0,  _ale_arg2,  _ale_arg4,  _ale_arg1) { return (((_ale_arg0 < (_ale_arg1 + _ale_arg2)) && (_ale_arg0 > (_ale_arg1 - _ale_arg2)) && (_ale_arg3 < (_ale_arg4 + _ale_arg2)) && (_ale_arg3 > (_ale_arg4 - _ale_arg2)))) ? 10.0 : 1.0; }
function leaf_absDist ( _ale_arg6,  _ale_arg1,  _ale_arg3,  _ale_arg2,  _ale_arg5,  _ale_arg4,  _ale_arg0) { return sqrt(((_ale_arg0 + _ale_arg1 / 2 + _ale_arg2 / 0.5) - _ale_arg3) * ((_ale_arg0 + _ale_arg1 / 2 + _ale_arg2 / 0.5) - _ale_arg3) + ((_ale_arg4 + _ale_arg5 / 2 + _ale_arg2 / 0.5) - _ale_arg6) * ((_ale_arg4 + _ale_arg5 / 2 + _ale_arg2 / 0.5) - _ale_arg6)); }
...
(function () {
    ...
    for (var i = 0; i < children.length; i++) {
      ...
      setAttribSafe(child, "radius", (getAttribSafe(node, "radius") ));
      logger.log("         step childs@radius: " + getAttribSafe(child, "radius"));
    }
  })();
...
function visit_top_0(node) {
  ...
  setAttribSafe(getChildByRefName(node,"child"), "radius", top_child_radius(getInputAttribSafe(node, "radius", '50')));
  logger.log("    top_child_radius: " + getAttribSafe(getChildByRefName(node,"child"), "radius"));
  logger.log("        radius: " + getInputAttribSafe(node, "radius", '50'));
...
function visit_top_1(node) {
  ...
  setAttribSafe(node, "h", top_h(getAttribSafe(getChildByRefName(node,"child"), "h"), getInputAttribSafe(node, "padding", '10')));
  logger.log("    top_h: " + getAttribSafe(node, "h"));
  logger.log("        child@h: " + getAttribSafe(getChildByRefName(node,"child"), "h"));
  logger.log("        padding: " + getInputAttribSafe(node, "padding", '10'));
  setAttribSafe(node, "w", top_w(getAttribSafe(getChildByRefName(node,"child"), "w"), getInputAttribSafe(node, "padding", '10')));
  logger.log("    top_w: " + getAttribSafe(node, "w"));
  logger.log("        child@w: " + getAttribSafe(getChildByRefName(node,"child"), "w"));
  logger.log("        padding: " + getInputAttribSafe(node, "padding", '10'));
  return true;
}
...
function visit_vbox_2(node) {
  ...
  setAttribSafe(node, "absdist", vbox_absDist(getAttribSafe(node, "mousey"), getAttribSafe(node, "w"), getAttribSafe(node, "mousex"), getAttribSafe(node, "radius"), getAttribSafe(node, "h"), getAttribSafe(node, "y"), getAttribSafe(node, "x")));
  logger.log("    vbox_absDist: " + getAttribSafe(node, "absdist"));
  logger.log("        mouseY: " + getAttribSafe(node, "mousey"));
  ...
  setAttribSafe(node, "mult", vbox_mult(getAttribSafe(node, "mousey"), getAttribSafe(node, "mousex"), getAttribSafe(node, "padding"), getAttribSafe(node, "y"), getAttribSafe(node, "x")));
  logger.log("    vbox_mult: " + getAttribSafe(node, "mult"));
  logger.log("        mouseY: " + getAttribSafe(node, "mousey"));
  logger.log("        mouseX: " + getAttribSafe(node, "mousex"));
  logger.log("        padding: " + getAttribSafe(node, "padding"));
  logger.log("        y: " + getAttribSafe(node, "y"));
...
function visit_hbox_2(node) {
  ...
  setAttribSafe(node, "absdist", hbox_absDist(getAttribSafe(node, "mousey"), getAttribSafe(node, "w"), getAttribSafe(node, "mousex"), getAttribSafe(node, "radius"), getAttribSafe(node, "h"), getAttribSafe(node, "y"), getAttribSafe(node, "x")));
  logger.log("    hbox_absDist: " + getAttribSafe(node, "absdist"));
  logger.log("        mouseY: " + getAttribSafe(node, "mousey"));
  logger.log("        w: " + getAttribSafe(node, "w"));
  logger.log("        mouseX: " + getAttribSafe(node, "mousex"));
  logger.log("        radius: " + getAttribSafe(node, "radius"));
  ...
  logger.log("        y: " + getAttribSafe(node, "y"));
  logger.log("        x: " + getAttribSafe(node, "x"));
  setAttribSafe(node, "mult", hbox_mult(getAttribSafe(node, "mousey"), getAttribSafe(node, "mousex"), getAttribSafe(node, "padding"), getAttribSafe(node, "y"), getAttribSafe(node, "x")));
  logger.log("    hbox_mult: " + getAttribSafe(node, "mult"));
  logger.log("        mouseY: " + getAttribSafe(node, "mousey"));
  logger.log("        mouseX: " + getAttribSafe(node, "mousex"));
  logger.log("        padding: " + getAttribSafe(node, "padding"));
  logger.log("        y: " + getAttribSafe(node, "y"));
...
function visit_leaf_2(node) {
  ...
  setAttribSafe(node, "absdist", leaf_absDist(getAttribSafe(node, "mousey"), getAttribSafe(node, "w"), getAttribSafe(node, "mousex"), getAttribSafe(node, "radius"), getAttribSafe(node, "h"), getAttribSafe(node, "y"), getAttribSafe(node, "x")));
  logger.log("    leaf_absDist: " + getAttribSafe(node, "absdist"));
  logger.log("        mouseY: " + getAttribSafe(node, "mousey"));
  logger.log("        w: " + getAttribSafe(node, "w"));
  logger.log("        mouseX: " + getAttribSafe(node, "mousex"));
  logger.log("        radius: " + getAttribSafe(node, "radius"));
  ...
  logger.log("        y: " + getAttribSafe(node, "y"));
  logger.log("        x: " + getAttribSafe(node, "x"));
  setAttribSafe(node, "mult", leaf_mult(getAttribSafe(node, "mousey"), getAttribSafe(node, "mousex"), getAttribSafe(node, "padding"), getAttribSafe(node, "y"), getAttribSafe(node, "x")));
...
(function () {
  ...
  logger.log("    last init hr: " + getAttribSafe(node, "hr"));
    setAttribSafe(node, "wr_init", (getAttribSafe(node, "padding") ));
  setAttribSafe(node, "wr", getAttribSafe(node, "wr_init"));
  logger.log("      init wr: " + getAttribSafe(node, "wr_init"));
  logger.log("    last init wr: " + getAttribSafe(node, "wr"));
  (function () {
    var children = getChildren(node, "childs", false);
    for (var i = 0; i < children.length; i++) {
      var child = children[i]; 
      ...
      setAttribSafe(node, "wr", (getAttribSafe(node, "wr") > (getAttribSafe(child, "wr") + getAttribSafe(node, "padding") * 2) ? getAttribSafe(node, "wr") : (getAttribSafe(child, "wr") + getAttribSafe(node, "padding") * 2)));
      logger.log("         step wr: " + getAttribSafe(node, "wr"));
    }
  })();
...
(function () {
  ...
  (function () {
    ...
    for (var i = 0; i < children.length; i++) {
      ...
      logger.log("         step hr: " + getAttribSafe(node, "hr"));
      setAttribSafe(node, "wr", (getAttribSafe(node, "wr") + getAttribSafe(child, "wr") + getAttribSafe(node, "padding") ));
      logger.log("         step wr: " + getAttribSafe(node, "wr"));
    }
  })();
...
function visit_vbox_4(node) {
  ...
  setAttribSafe(node, "render", vbox_render(getAttribSafe(node, "hr"), getAttribSafe(node, "yr"), getAttribSafe(node, "xr"), getAttribSafe(node, "wr")));
...
function visit_hbox_4(node) {
  ...
  setAttribSafe(node, "render", hbox_render(getAttribSafe(node, "hr"), getAttribSafe(node, "yr"), getAttribSafe(node, "xr"), getAttribSafe(node, "wr")));
...
function visit_leaf_4(node) {
  ...
  setAttribSafe(node, "render", leaf_render(getAttribSafe(node, "hr"), getAttribSafe(node, "mousey"), getAttribSafe(node, "yr"), getAttribSafe(node, "mousex"), getAttribSafe(node, "xr"), getAttribSafe(node, "canvas"), getAttribSafe(node, "wr")));
